<template>
  <MainLayout>
    <section class="signup-student py-4">
            ...
            <form method="post" @submit.prevent="submit" class="p-3">
              ...
              <div class="row">
                <div class="form-group col-lg-6 mb-md-4">
                  <label class="control-label">နာမည်</label>
                  <input type="text" v-model="signupForm.name" class="form-control" placeholder="နာမည် ဖြည့်ပါ">
                  <div class="error text-danger" v-if="submitted && !$v.signupForm.name.required">ဖြည့်ရန်လိုအပ်ပါသည်</div>
                  <div class="error text-danger" v-if="submitted && !$v.signupForm.name.maxLength">နာမည်သည် စာလုံရေ ၁၀၀ ထက်မကျော်ရပါ</div>
                </div>
                <div class="form-group col-lg-6 mb-md-4">
                  <label class="control-label">ကျောင်းအမည် (တက်နေဆဲ/ပြီးဆုံး/အခြား)</label>
                  <input type="text" v-model="signupForm.school_name" class="form-control" placeholder="ကျောင်းအမည် ဖြည့်ပါ">
                  <div class="error text-danger" v-if="submitted && !$v.signupForm.school_name.maxLength">ကျောင်းအမည်သည် စာလုံးရေ ၁၀၀ ထက်မကျော်ရပါ</div>
                </div>
                <div class="form-group col-lg-6 mb-md-4">
                ...
                <div class="form-group col-lg-6 mb-md-4">
                  <label class="control-label">ကျား/မ</label>
                  <div>
                    <div class="form-check-inline">
                      <label class="form-check-label">
                        <input type="radio" v-model="signupForm.gender" value="1" class="form-check-input"> ကျား
                      </label>
                    </div>
                    <div class="form-check-inline">
                      <label class="form-check-label">
                        <input type="radio" v-model="signupForm.gender" value="2" class="form-check-input"> မ
                      </label>
                    </div>
                  </div>
                  ...
                  <div class="form-group mb-md-4">
                    ...
                    <div class="d-flex flex-wrap align-items-center">
                      ...
                      <div class="col-6 col-md-4 col-xl-3 pl-0">
                        <input type="text" v-model="signupForm.nrc_number" placeholder="မှတ်ပုံတင်နံပါတ်" class="form-control" 
                          :disabled="!nrckey  || !selectedNrcName || !selectedNrcNaing" id="nrc_number" maxlength="6">
                      </div>
                    </div>
                    ...
                    <div class="error text-danger" v-if="submitted && !$v.signupForm.nrc_valid.maxLength">မှတ်ပုံတင် နံပါတ်သည် ၆ လုံး ထက်မကျော်ရပါ</div>
                ...
                <div class="form-group col-lg-6 mb-md-4 nrc-signup">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="file-upload ml-2" id="file-upload-front">
                      <span for="inputImg" id="upload-button-front" @click="$refs.frontPhoto.click()">ပုံရွေးရန်</span>
                      <input type="file" id="nrc-front-photo" v-on:change="onNrcFrontChange" class="file-upload d-none" ref="frontPhoto" accept="image/*" />
                    </div>
                  </div>
                ...
                <div class="form-group col-lg-6 mb-md-4 nrc-signup">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="file-upload ml-2" id="file-upload-back">
                      ...
                      <input type="file" id="nrcback" v-on:change="onNrcBackChange" class="file-upload d-none" ref="backPhoto" accept="image/*"/>
                    </div>
                  </div>
                ...
                <div class="form-group col-lg-6 mb-md-4">
                  ...
                  <div class="error text-danger" v-if="submitted && !$v.signupForm.phone_number_1.maxLength">ဖုန်းနံပါတ် ၁ စာလုံး အရေအတွက်သည် ၂၀ ထက်မကျော်ရပါ</div>
                  <!-- <div class="error text-danger" v-if="submitted && !$v.signupForm.phone_number_1.numeric">ဖုန်းနံပါတ် ၁ သည် နံပါတ် ဖြစ်ရပါမည်။</div> -->
                </div>
                <div class="form-group col-lg-6 mb-md-4">
                ...
                <div class="form-group col-lg-6 mb-md-4">
                  ...
                  <textarea rows="4" v-model="signupForm.address" class="editor" placeholder="လိပ်စာ ဖြည့်ပါ"></textarea>
              ...
              <div class="form-group mb-0 pyidaungsu-regular">
                ...
                <p>အကောင့်ရှိပြီးသားလား? <router-link :to="{ name: 'login'}" class="text-success">အကောင့်ဝင်ရန်</router-link></p>
              </div>
            </form>
          </div>
        </div>
...
<script src="../../services/student/signup-student.js"></script>

<style src="../../assets/css/student/signup-student.css"></style>
