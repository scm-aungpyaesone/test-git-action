...
export default {
    ...
    methods: {
        ...
        one_field_required_check() {
            var name = this.signupForm.name;
            var school_name = this.signupForm.school_name;
            if (name == "" && school_name == "") {
        ...
        submit() {
            ...
            // this.signupForm.phno_valid = convertNumberService.convertMm2Eng(this.signupForm.phone_number_1);
        ...
        signUp() {
            ...
            data.append('education', this.signupForm.education);
            data.append('experience', this.signupForm.experience);
            data.append('message', this.signupForm.message);
            ...
            axios.post("/teacher/signup", data, {
                    headers: {
                        "Content-Type": "application/json",
                    },
                })
                .then((response) => {
                    this.$notification.success("သင့်ရဲ့ အကောင့်နံပါတ် " + response.data.teacher_no, {
                        timer: 20,
                        position: 'topCenter'
                    });
                    this.$router.push({
